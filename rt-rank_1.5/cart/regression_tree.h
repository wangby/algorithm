...
public:
  ...
  static bool find_split(vector<tuple*> data, vector<int> countData, vector<int> invertIdx, int NF, int& fsplit, double& vsplit, int K, bool par, const args_t& args);
  ...
  static bool entropy_split(data_t data, vector<int> countData, vector<int> invertIdx, int NF, int& fsplit, double& vsplit, int K, bool par);
